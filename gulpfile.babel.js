...
// TASKS ///////////////////////////////////////////////////////////////////////
gulp.task('build',
  gulp.series(gulp.parallel(pretty, clean), gulp.parallel(pages, sass, gulp.series(javascript, test), images, copy)))
...
// JS //////////////////////////////////////////////////////////////////////////
const webpackConfig = {module:{rules:[{test:/(.js|.ts|.jsx)$/, use:[{loader:'babel-loader'}]}]}}
function javascript() {
